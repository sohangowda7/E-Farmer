                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="about-us-footer">
                                    <div class="footer-logo">
                                        <a href="#"><img src="img/eFarmerlogo.jpg" height=250px width=250px alt=""></a>
                                    </div>
                                    <div class="footer-info">
                                        <p class="phone">+91-090909090</p>
                                    </div>
                                </div>
                            </div>
...
?>
                                        ...
                                        <div class="col-lg-5 offset-xl-1 col-md-6 col-sm-6">
                                            ...
                                            <div class="block-contact-text">
                                                <p> eFarmer<br> Bangalore.<br>India</p>
                                                <p>Call us: <span>+91-909090990 </span></p>
                                                <p>Email us: <span>contact@eFarmer.com</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="copyright">Copyright &copy; eFarmer. All Rights Reserved</div>
                            </div>	
                            <div class="col-lg-6 col-md-6">
