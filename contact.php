...
if(isset($_POST['submit']))
{
	...
	//$owneremailid="studentprojects.live@gmail.com";
	$owneremailid="amiriqbal6845121@gmail.com";
	$title = "Enquiry Mail";
	$msg = "
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6 col-xs-12 plr-0">
                            <div class="contact-address-area">
                                ...
                                <ul>
                                    <li>
                                        <i class="fa fa-fax">&nbsp;</i> Address : eFarmer, Bangalore-560097</li>
                                    <li>
                                        <i class="fa fa-phone">&nbsp;</i>eFarmer.com</li>
                                    <li>
                                        <i class="fa fa-envelope-o"></i>&nbsp;+909090090</li>
                                </ul>
                            </div>
                        </div>
